(function() {
  ...
  function startPlugin() {
    ...
    var hint1 = '<div style="display: block;"><div class="hints" style="display:none; line-height: 0.5;color: #ffbfbf;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;text-align: center;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;border-radius: 0.3em;"><div style="-webkit-box-flex: 1;    -webkit-flex-grow: 1;    -moz-box-flex: 1;    -ms-flex-positive: 1;    flex-grow: 1;    line-height: 1.5;"><span style="padding: 0.5em;margin-right: 0.8em;"><img style="max-width: 2em;" src="https://lampa.vip/lampa-main/img/hints.png"></span>Злоупотребление бессмысленными запросами чревато автоблокировкой вашего IP-адреса</div></div></div>'
    var hint2 = '<div style="display: block;"><div class="hints" style="display:none; line-height: 0.5;color: #ffbfbf;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;text-align: center;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;border-radius: 0.3em;"><div style="-webkit-box-flex: 1;    -webkit-flex-grow: 1;    -moz-box-flex: 1;    -ms-flex-positive: 1;    flex-grow: 1;    line-height: 1.5;"><span style="padding: 0.5em;margin-right: 0.8em;"><img style="max-width: 2em;" src="https://lampa.vip/lampa-main/img/hints.png"></span>Злоупотребление бессмысленными запросами чревато автоблокировкой вашего IP-адреса</div></div></div>'
    var hints = [hint1, hint2]
    Lampa.Storage.listener.follow('change', function(event) {
        if (event.name == 'activity') {
            if (Lampa.Activity.active().component == 'lampa_vip') {
                var randomHint = hints[Math.floor(Math.random() * hints.length)]
                var add_hints = setInterval(function() {
                    if (document.querySelector('.online-prestige-watched') !== null) {
                        $('.online-prestige-watched').html(randomHint);
                        clearInterval(add_hints);
                    }
                }, 50);
            }
        }
