(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;padding-right:1.4em;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;overflow:hidden;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;padding-right:1.4em;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;padding-right:1.4em;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{position:absolute!important;z-index:1!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;padding-right:1.4em!important;white-space:nowrap!important;font-size:1.3em!important;border:none!important;min-height:0!important;margin:0!important;overflow:visible!important}' +
            '.card__vote-line{width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;font-size:1.3em!important;border:none!important;min-height:0!important;margin:0!important;overflow:hidden!important}' +
            ...
            '.card__vote .source--name{font-size:0.6em;position:absolute!important;right:0.25em!important;top:50%!important;transform:translateY(-50%)!important;color:transparent;width:1.2em;height:1.2em;display:block!important;overflow:hidden;background-repeat:no-repeat;background-position:center;background-size:contain;margin:0!important;padding:0!important;vertical-align:baseline!important}' +
            ...
            '.card__vote.rate--lampa img{position:absolute!important;right:0.25em!important;top:50%!important;transform:translateY(-50%)!important;max-height:1.2em!important;max-width:1.2em!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin:0!important;padding:0!important;vertical-align:baseline!important}' +
