(function () {
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{display:-webkit-box;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center!important;height:auto!important;overflow:visible!important;position:absolute!important;z-index:1!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.3em!important}' +
            '.card__vote-line{width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;display:-webkit-box!important;display:-webkit-flex!important;display:flex!important;-webkit-flex-direction:column!important;flex-direction:column!important;-webkit-align-items:flex-end!important;align-items:flex-end!important;gap:1px!important;font-size:1.3em!important}' +
            ...
            '.card__vote .source--name{font-size:inherit;color:transparent;width:1em;height:1em;display:inline-block;overflow:hidden;background-repeat:no-repeat;background-position:center;background-size:contain;margin-left:0.3em;-webkit-flex-shrink:0;flex-shrink:0}' +
            '@media (min-width:481px){.card__vote,.card__vote-line,.card__vote-separate-wrap,.card__vote-separate-wrap .card__vote{font-size:1.3em!important}.card__vote .source--name{margin-left:0.3em}}' +
            ...
            '.card__vote.rate--lampa img{width:1em!important;height:1em!important;min-width:0!important;min-height:0!important;max-width:1em!important;max-height:1em!important;object-fit:contain!important;-webkit-flex-shrink:0;flex-shrink:0;vertical-align:middle;margin-left:0.3em!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{margin-left:0.3em!important}}' +
