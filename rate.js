(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;display:flex;align-items:center;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;display:flex;align-items:center;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;display:flex;flex-direction:column;align-items:flex-start;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{display:flex!important;align-items:center!important;justify-content:flex-start!important;position:absolute!important;z-index:1!important;width:auto!important;min-width:2.8em!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.1em!important;height:auto!important;border:none!important;margin:0!important}' +
            '.card__vote-line{display:flex!important;flex-direction:column!important;align-items:flex-start!important;position:absolute!important;width:auto!important;min-width:2.8em!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;font-size:1.1em!important;height:auto!important;border:none!important;margin:0!important}' +
            ...
            '.card__vote-separate-wrap .card__vote{display:flex!important;align-items:center!important;justify-content:flex-start!important;position:static!important;width:100%!important;min-width:2.8em!important;max-width:100%!important;padding:0.2em 0.45em!important;white-space:nowrap!important;flex-shrink:0!important;box-sizing:border-box!important;transform:none!important;font-size:1.1em!important;height:auto!important;border:none!important;margin:0!important}' +
            ...
            '.card__vote.rate--lampa img{display:block!important;max-height:16px!important;max-width:16px!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin-left:auto!important;height:auto!important;width:auto!important;flex-shrink:0!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:18px!important;max-width:18px!important}}' +
            '.rate--lampa.rate--lampa--animated .rate-icon img{max-height:18px;max-width:18px;object-fit:contain;display:block!important;margin-left:auto!important}' +
