(function () {
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote.rate--lampa img{display:block!important;max-height:18px!important;max-width:18px!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin-left:auto!important;height:auto!important;width:auto!important;flex-shrink:0!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:20px!important;max-width:20px!important}}' +
            '.rate--lampa.rate--lampa--animated .rate-icon img{max-height:20px;max-width:20px;object-fit:contain;display:block!important;margin-left:auto!important}' +
