(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'display:inline-block;line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'display:inline-block;line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;overflow:hidden;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'display:inline-block;line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{display:inline-block!important;position:absolute!important;z-index:1!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.3em!important;line-height:1!important;height:auto!important;min-height:0!important;max-height:none!important;border:none!important;border-radius:4px!important;margin:0!important;overflow:hidden!important}' +
            '.card__vote-line{display:inline-block!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;font-size:1.3em!important;line-height:1!important;height:auto!important;min-height:0!important;max-height:none!important;border:none!important;border-radius:4px!important;margin:0!important;overflow:hidden!important}' +
            ...
            '.card__vote-separate-wrap .card__vote{display:inline-block!important;position:static!important;width:auto!important;min-width:0!important;max-width:100%!important;padding:0.2em 0.45em!important;white-space:nowrap!important;-webkit-flex-shrink:0!important;flex-shrink:0!important;box-sizing:border-box!important;transform:none!important;overflow:hidden!important;font-size:1.3em!important;line-height:1!important;height:auto!important;min-height:0!important;max-height:none!important;border:none!important;border-radius:4px!important;margin:0!important}' +
            ...
            '.card__vote .source--name{font-size:0.6em;display:inline-block!important;vertical-align:middle!important;color:transparent;width:1.2em;height:1.2em;overflow:hidden;background-repeat:no-repeat;background-position:center;background-size:contain;margin-left:0.2em!important;padding:0!important}' +
            ...
            '.card__vote.rate--lampa img{display:inline-block!important;vertical-align:middle!important;max-height:0.8em!important;max-width:0.8em!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin-left:0.2em!important;height:auto!important;width:auto!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:0.8em!important;max-width:0.8em!important}}' +
