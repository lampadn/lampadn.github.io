(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;overflow:hidden;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'line-height:1;font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-flex-direction:column;flex-direction:column;-webkit-align-items:flex-end;align-items:flex-end;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{display:-webkit-box;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center!important;height:auto!important;overflow:hidden!important;position:absolute!important;z-index:1!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.3em!important;line-height:1!important;border:none!important;min-height:0!important;margin:0!important}' +
            '.card__vote-line{width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;display:-webkit-box!important;display:-webkit-flex!important;display:flex!important;-webkit-flex-direction:column!important;flex-direction:column!important;-webkit-align-items:flex-end!important;align-items:flex-end!important;gap:1px!important;font-size:1.3em!important;line-height:1!important;border:none!important;min-height:0!important;margin:0!important;overflow:hidden!important}' +
            ...
            '.card__vote-separate-wrap .card__vote{position:static!important;width:auto!important;min-width:0!important;max-width:100%!important;padding:0.2em 0.45em!important;white-space:nowrap!important;-webkit-flex-shrink:0!important;flex-shrink:0!important;box-sizing:border-box!important;transform:none!important;overflow:hidden!important;font-size:1.3em!important;line-height:1!important;border:none!important;min-height:0!important;margin:0!important}' +
            ...
            '.card__vote .source--name{font-size:0.6em;color:transparent;width:1em;height:1em;display:block;overflow:hidden;background-repeat:no-repeat;background-position:center;background-size:contain;margin-left:0.3em;-webkit-flex-shrink:0;flex-shrink:0}' +
            ...
            '.card__vote.rate--lampa img{max-height:1em!important;max-width:1em!important;min-width:0!important;min-height:0!important;object-fit:contain!important;-webkit-flex-shrink:0;flex-shrink:0;vertical-align:middle;margin-left:0.3em!important;height:auto!important;width:auto!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:1em!important;max-width:1em!important}}' +
