(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{display:block!important;position:absolute!important;z-index:1!important;width:auto!important;min-width:2.5em!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.1em!important;text-align:center!important;height:auto!important;border:none!important;margin:0!important}' +
            '.card__vote-line{display:block!important;position:absolute!important;width:auto!important;min-width:2.5em!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;font-size:1.1em!important;text-align:center!important;height:auto!important;border:none!important;margin:0!important}' +
            '.card__vote-separate-wrap{background:transparent!important;padding:0!important;width:auto!important;min-width:2.5em!important;max-width:100%!important;overflow:visible!important;transform:scale(var(--rating-scale,1))!important;display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:0!important;font-size:1.1em!important}' +
            '.card__vote-separate-wrap .card__vote{display:block!important;position:static!important;width:100%!important;min-width:2.5em!important;max-width:100%!important;padding:0.2em 0.45em!important;white-space:nowrap!important;flex-shrink:0!important;box-sizing:border-box!important;transform:none!important;font-size:1.1em!important;text-align:center!important;height:auto!important;border:none!important;margin:0!important}' +
            ...
            '.card__vote .source--name{font-size:0!important;display:inline-block!important;vertical-align:middle!important;color:transparent!important;width:14px!important;height:14px!important;overflow:hidden!important;background-repeat:no-repeat!important;background-position:center!important;background-size:contain!important;margin-left:0.2em!important;padding:0!important;border:none!important}' +
            '@media (min-width:481px){.card__vote .source--name{width:16px!important;height:16px!important}}' +
            ...
            '.card__vote.rate--lampa img{display:inline-block!important;vertical-align:middle!important;max-height:14px!important;max-width:14px!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin-left:0.2em!important;height:auto!important;width:auto!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:16px!important;max-width:16px!important}}' +
            '.rate--lampa.rate--lampa--animated .rate-icon img{max-height:16px;max-width:16px;object-fit:contain}' +
