(function () {
    ...
    function createRatingElement(card, verticalOffsetEm) {
        ...
        ratingElement.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function createRatingInnerBlock() {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        el.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;overflow:hidden;background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
        return el;
    }
    ...
    function createRatingLineElement(card) {
        ...
        var bgAlpha = getRatingBackgroundAlpha();
        line.style.cssText = 'font-family:"SegoeUI",sans-serif;cursor:pointer;box-sizing:border-box;outline:none;user-select:none;position:absolute;z-index:1;overflow:hidden;' + posCSS + 'background:rgba(0,0,0,' + bgAlpha + ');color:#fff;padding:0.2em 0.45em;';
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.card__vote{position:absolute!important;z-index:1!important;width:auto!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important;transform:scale(var(--rating-scale,1))!important;padding:0.2em 0.45em!important;white-space:nowrap!important;font-size:1.3em!important;border:none!important;min-height:0!important;margin:0!important}' +
            ...
            '.card__vote .source--name{font-size:0.6em;color:transparent;width:1em;height:1em;display:inline-block!important;overflow:hidden;background-repeat:no-repeat;background-position:center;background-size:contain;margin-left:0.3em;vertical-align:middle;-webkit-flex-shrink:0;flex-shrink:0}' +
            ...
            '.card__vote.rate--lampa img{max-height:1em!important;max-width:1em!important;min-width:0!important;min-height:0!important;object-fit:contain!important;vertical-align:middle;margin-left:0.3em!important;height:auto!important;width:auto!important}' +
