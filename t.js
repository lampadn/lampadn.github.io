(function() {
    ...
    function component(object) {
        ...
        this.filter = function(filter_items, choice) {
            ...
            var current_sub = 'http://beta.l-vid.online:888/';
    ...
    function startPlugin() {
        window.beta_lvid_plugin = true;
        if (!window.plugin_beta_lvid_ready && !window.plugin_iptv_ready2) {
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    name: 'Отображать Beta L-Vid 2.0',
            ...
            Lampa.SettingsApi.addParam({
                component: 'beta_lvid',
                param: {
                    name: 'betaonline2_view',
                    type: 'trigger',
                    default: false,
                },
                field: {
                    name: 'Спрятать значок Beta L-Vid 2.0',
        ...
        var manifst = {
            ...
            onContextLauch: function onContextLauch(object) {
                resetTemplates();
                Lampa.Component.add('beta_lvid', component);
    ...
    if (!window.beta_lvid_plugin) startPlugin();
