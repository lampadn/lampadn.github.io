(function() {
    'use strict';
    var Defined = { api: 'lampac', localhost: 'https://lampa.vip/', apn: '' };
    ...
    function startPlugin() {
        ...
        Lampa.Template.add('lampac_css', `...`); // CSS остается без изменений
        $('body').append(Lampa.Template.get('lampac_css', {}, true));

        function resetTemplates() {
            // все Lampa.Template.add остаются без изменений
        ...
        var button = "<div class=\"full-start__button selector view--online lampac--button\" data-subtitle=\"".concat(manifst.name, " v").concat(manifst.version, "\"> ... </div>";
