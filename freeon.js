(function() {
    ...
    function component(object) {
        ...
        if (balansers_with_search == undefined) {
            ...
            network.silent(requestUrl(Defined.localhost + 'lite/withsearch'), function(json) {
        ...
        this.initialize = function() {
            ...
            if(object.balanser){
                ...
                filter_sources = [];
                return network["native"](requestUrl(object.url.replace('rjson=','nojson=')), this.parse.bind(this), function(){
        ...
        this.externalids = function() {
            return new Promise(function(resolve, reject) {
                if (!object.movie.imdb_id || !object.movie.kinopoisk_id) {
                    ...
                    network.timeout(10000);
                    network.silent(requestUrl(url), function(json) {
        ...
        this.request = function(url) {
            ...
            if (number_of_requests < 10) {
                network["native"](requestUrl(url), this.parse.bind(this), this.doesNotAnswer.bind(this), false, { dataType: 'text' });
        ...
        this.getFileUrl = function(file, call) {
            ...
            if(Lampa.Storage.field('player') !== 'inner' && file.stream && Lampa.Platform.is('apple')){
                ...
                network["native"](requestUrl(file.url), function(json) {
                    if(json.rch){
            ...
            json.forEach(function(elem) {
                ...
                if (elem.img) {
                    ...
                    if (elem.img !== undefined) {
                        ...
                        if (elem.img.indexOf('/proxyimg') !== -1) elem.img = requestUrl(elem.img);
                    }
            ...
            search: function(params, oncomplite) {
                function searchComplite(links) {
                    ...
                    if (keys.length) {
                                ...
                                if (line && line.data && line.type == 'similar') {
                                    var cards = line.data.map(function(item) {
                                        ...
                                        if (item.img !== undefined) {
                                            ...
                                            if (item.img.indexOf('/proxyimg') !== -1) item.img = requestUrl(item.img);
                                        }
                                        return item;
                                    });
                        ...
                        keys.forEach(function(name) {
                            network.silent(requestUrl(links[name]), function(data) {
                ...
                network.silent(requestUrl(Defined.localhost + 'lite/' + spiderUri + '?title=' + params.query), function(json) {
                    if (json.rch) {
                        rchRun(json, function() {
                            network.silent(requestUrl(Defined.localhost + 'lite/' + spiderUri + '?title=' + params.query), function(links) {
